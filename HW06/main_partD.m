...
save_figure(fig,['results/partD_numSteps_' 'beta' num2str(RL.beta) '_eps' num2str(RL.epsilon) '_gamma' num2str(RL.gamma) '_lambda' num2str(RL.lambda) '.png']);
...
save_figure(fig,['results/partD_optimalPathRatio_' 'beta' num2str(RL.beta) '_eps' num2str(RL.epsilon) '_gamma' num2str(RL.gamma) '_lambda' num2str(RL.lambda) '.png']);
...
hold on; plot(x, f(B,x), '-r')
save_figure(fig,['results/partD_optimalPathDiff_' 'beta' num2str(RL.beta) '_eps' num2str(RL.epsilon) '_gamma' num2str(RL.gamma) '_lambda' num2str(RL.lambda) '.png']);
...
save_figure(fig,['results/partD_pathPlotAll_' 'beta' num2str(RL.beta) '_eps' num2str(RL.epsilon) '_gamma' num2str(RL.gamma) '_lambda' num2str(RL.lambda) '.png']);
fig = figure('Color','w','ToolBar','none','MenuBar','none', 'units','normalized','outerposition',[0.1 0 0.8 1]);
...
save_figure(fig,['results/partD_pathPlotLast_' 'beta' num2str(RL.beta) '_eps' num2str(RL.epsilon) '_gamma' num2str(RL.gamma) '_lambda' num2str(RL.lambda) '.png']);
%% plot valuemap
fig = figure('Color','w','ToolBar','none','MenuBar','none', 'units','normalized','outerposition',[0.1 0 0.8 1]);
trials = [1 10 100 1000];
for  i = 1:length(trials)
...
save_figure(fig,['results/partD_valuemapAll_' 'beta' num2str(RL.beta) '_eps' num2str(RL.epsilon) '_gamma' num2str(RL.gamma) '_lambda' num2str(RL.lambda) '.png']);
fig = figure('Color','w','ToolBar','none','MenuBar','none', 'units','normalized','outerposition',[0.1 0 0.8 1]);
trials = [9970 9980 9990 10000];
for  i = 1:length(trials)
    subplot(2,2,i);
...
save_figure(fig,['results/partD_valuemapLast_' 'beta' num2str(RL.beta) '_eps' num2str(RL.epsilon) '_gamma' num2str(RL.gamma) '_lambda' num2str(RL.lambda) '.png']);

%%
try close(video.stream); close(video.fig); catch,end
video = video_make(['results/partD_pathSimulated_' 'beta' num2str(RL.beta) '_eps' num2str(RL.epsilon) '_gamma' num2str(RL.gamma) '_lambda' num2str(RL.lambda)]);
